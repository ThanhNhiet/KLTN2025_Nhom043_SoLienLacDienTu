...
const UpdateGrchatModal: React.FC<UpdateGrchatModalProps> = ({ isOpen, onClose, onSuccess, chat }) => {
  const { addMembers2GroupChat, getStudentInfo, getLecturerInfo, loading, loadingAddMembers } = useChat();
      ...
      <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end space-x-3">
            ...
            <button
              type="submit"
              disabled={loadingAddMembers || (selectedLecturers.length === 0 && selectedStudents.length === 0)}
            ...
            >
              ...
              <span>{loadingAddMembers ? 'Đang cập nhật...' : 'Thêm'}</span>
            </button>
          </div>
        </form>
      </div>
